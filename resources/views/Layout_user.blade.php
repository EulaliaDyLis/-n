    ...
    <div id="page">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 logo-block">
                        <!-- Header Logo -->
                        <div class="logo">
                            <a title="Linea HTML Template" href="{{ route('home') }}"><img width="120" alt="Linea HTML"
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-3 hidden-xs category-search-form">
                        <div class="search-box">
                            <form id="search_mini_form" action="{{ route('home.create') }}" method="get">
                                ...
                                <input id="search" type="text" name="search" placeholder="Nhập thông tin cần tìm..."
        ...
        <footer class="footer">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                    <div class="col-sm-5 col-xs-12 coppyright"> &copy; {{ now()->format('Y') }} Sneaker Store.
